...
const file_auth_proto_rawDesc = "" +
	...
	"\x04role\x18\x02 \x01(\tR\x04role2\xc4\x01\n" +
	"\vAuthService\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB\x18Z\x16shared/proto/auth;authb\x06proto3"
